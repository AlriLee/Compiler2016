...
public interface MagListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code dimension_void}
	 * labeled alternative in {@link MagParser#dimensionExpression}.
	 *
	 * @param ctx the parse tree
	 */
	void enterDimension_void(MagParser.Dimension_voidContext ctx);

	/**
	 * Exit a parse tree produced by the {@code dimension_void}
	 * labeled alternative in {@link MagParser#dimensionExpression}.
	 *
	 * @param ctx the parse tree
	 */
	void exitDimension_void(MagParser.Dimension_voidContext ctx);

	/**
	 * Enter a parse tree produced by the {@code dimVoid_}
	 * labeled alternative in {@link MagParser#dimensionVoidExpression}.
	 *
	 * @param ctx the parse tree
	 */
	void enterDimVoid_(MagParser.DimVoid_Context ctx);

	/**
	 * Exit a parse tree produced by the {@code dimVoid_}
	 * labeled alternative in {@link MagParser#dimensionVoidExpression}.
	 *
	 * @param ctx the parse tree
	 */
	void exitDimVoid_(MagParser.DimVoid_Context ctx);

	/**
	 * Enter a parse tree produced by the {@code dimVoid_d}
	 * labeled alternative in {@link MagParser#dimensionVoidExpression}.
	 *
	 * @param ctx the parse tree
	 */
	void enterDimVoid_d(MagParser.DimVoid_dContext ctx);

	/**
	 * Exit a parse tree produced by the {@code dimVoid_d}
	 * labeled alternative in {@link MagParser#dimensionVoidExpression}.
	 *
	 * @param ctx the parse tree
	 */
	void exitDimVoid_d(MagParser.DimVoid_dContext ctx);
