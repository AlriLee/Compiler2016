...
#	%consequence0
_consequence0:
#	$2 = call stringConcatenate "move " $28
	la $a0, string_1
	lw $a1, 192($sp)
	jal func__stringConcatenate
	move $t2, $v0
#	$4 = call stringConcatenate $2 " --> "
	move $a0, $t2
	la $a1, string_3
	jal func__stringConcatenate
	move $t2, $v0
#	$5 = call stringConcatenate $4 $30
	move $a0, $t2
	lw $a1, 200($sp)
	jal func__stringConcatenate
	move $t2, $v0
...
#	$31 = move $10
	sw $t2, 204($sp)
#	$12 = call stringConcatenate "move " $28
	la $a0, string_11
	lw $a1, 192($sp)
	jal func__stringConcatenate
	move $t2, $v0
#	$14 = call stringConcatenate $12 " --> "
	move $a0, $t2
	la $a1, string_13
	jal func__stringConcatenate
	move $t2, $v0
#	$15 = call stringConcatenate $14 $30
	move $a0, $t2
	lw $a1, 200($sp)
	jal func__stringConcatenate
	move $t2, $v0
